...
order by date;
    ...
    //geo	    
        ...
        public function fetchPercentFacHWTrainedDetails($training_type, &$locationNames, $where, $groupFieldName, $havingName, $geoList, $tierValue){
                ...
                $coverage = $coverageHelper->getCoverageCountFacWithTrainedHW($training_type, $tt_where, $locationWhereClause, $locationNames, $groupFieldName, $havingName, $geoList, $tierText);
